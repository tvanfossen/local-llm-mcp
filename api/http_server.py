...
def create_http_server(
        ...
        try:
            ...
            if request.method == "POST":
                ...
                try:
                    ...
                    response_data = await mcp_handler.handle_jsonrpc_request(
    ...
    async def websocket_endpoint(websocket):
        ...
        routes = [
            ...
            # MCP endpoints
            Route("/mcp", mcp_streamable_http_handler, methods=["POST", "GET"]),
            Route("/mcp-legacy", mcp_legacy_handler, methods=["POST"]),
            ...
            # WebSocket endpoint - MUST use WebSocketRoute
        ...
        for path, handler, methods in orchestrator_api.get_routes():
            if "websocket" in methods:
                # Skip the /ws route from orchestrator since we defined it above
                if path != "/ws":
