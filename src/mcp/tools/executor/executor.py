...
class MCPToolExecutor:
            ...
            "chat_with_agent": {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "task_type": {"type": "string", "enum": ["update", "create", "analyze", "refactor", "debug", "document", "test"], "description": "Type of task"}
                    },
    ...
    async def _create_agent(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "content": [{"type": "text", "text": f"❌ **Create Agent Failed:** {str(e)}"}],
                "isError": True
            }
    ...
    async def _list_agents(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "content": [{"type": "text", "text": agent_list}],
                "isError": False
            }
        except Exception as e:
            logger.error(f"Failed to list agents: {e}")
            return {
                "content": [{"type": "text", "text": f"❌ **List Agents Failed:** {str(e)}"}],
                "isError": True
            }
    ...
    async def _get_agent_info(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "content": [{"type": "text", "text": f"❌ **Get Agent Info Failed:** {str(e)}"}],
                "isError": True
            }
    ...
    async def _delete_agent(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "content": [{"type": "text", "text": f"❌ **Delete Agent Failed:** {str(e)}"}],
                "isError": True
            }
        ...
        try:
            ...
            if response.success:
                return {
                    "content": [{
                        "type": "text",
                        "text": f"💬 **Agent Response** ({agent.state.name}):\n\n{response.content}"
                    }],
                    "isError": False
                }
            else:
    ...
    async def _get_agent_file(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            if not agent.managed_files:
                return {
                    "content": [{"type": "text", "text": f"📭 **No Files:** Agent {agent.state.name} has no managed files"}],
                    "isError": False
                }
            ...
            return {
                "content": [{"type": "text", "text": f"❌ **Get File Failed:** {str(e)}"}],
                "isError": True
            }
    ...
    async def _system_status(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                "content": [{"type": "text", "text": f"❌ **System Status Failed:** {str(e)}"}],
                "isError": True
            }